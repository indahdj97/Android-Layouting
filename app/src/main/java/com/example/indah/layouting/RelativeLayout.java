    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btKembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder pesan = new AlertDialog.Builder(RelativeLayout.this);
                ...
                pesan.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(RelativeLayout.this,"Success", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(RelativeLayout.this, MenuActivity.class);
                        startActivity(i);
                    }
                });
